...
exports.onCreateActivityFeedItem = firestore
  ...
  onCreate(async (snapshot,context)=>{
    ...
    if(androidNotificationToken) {
      ...
      console.log('No token User,cannot send Notification')
    }
    ...
    function sendNotification(androidNotificationToken,activityFeedItem){
      ...
      switch(activityFeedItem.type) {
        ...
        case 'like':
          ...
          body ="${activityFeedItem.username} liked yur Post";
          break;
      case 'follow':
      ...
      .catch(error => {
        console.log('Error sendiing message',error);
      });
